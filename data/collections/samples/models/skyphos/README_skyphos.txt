these are the files that i altered in order to insert my glb model:
-hy553_project-main\wapps\app_template\js\main.js
ATON.createSceneNode("sample").load("samples/models/skyphos/Ball_Return_with_motor.glb").attachToRoot();

-hy553_project-main\data\scenes\samples\skyphos\scene.json
{
  "scenegraph": {
    "nodes": {
      "main": {
        "urls": ["samples/models/skyphos/Ball_Return_with_motor.glb"]
      }
    }
  }
}
...
---------------------------------new-----------------------------------------------
{
  ...
  "description": "physics classroom demo",
  "environment": {
    "mainpano": {
      "url": "samples/pano/defsky-grass.jpg"
    },
    "lightprobes": {
      "auto": true
    },
    "mainlight": {
      "direction": [-0.1, -0.8, -0.6],
      "intensity": 1.5
    }
  },
//   "scenegraph": {
...
//     },
//     "classroom": {
//       "urls": ["samples/models/skyphos/basic_classroom.glb"],
//       "position": [2, 0, 0]
...
"scenegraph": {
  "nodes": {
    "main": {
      "urls": ["samples/models/skyphos/physics_class.glb"],
      "position": [2, 0, 2]
